// DOM Elements
        ...
        style.textContent = `
            ...
            /* Add subtle pulse to slide numbers */
            .slide-number {
                animation: pulseSlideNumber 3s infinite ease-in-out;
            }
            
            @keyframes pulseSlideNumber {
                0%, 100% { transform: scale(1); box-shadow: 0 5px 15px rgba(0,120,212,0.3); }
                50% { transform: scale(1.05); box-shadow: 0 8px 20px rgba(0,120,212,0.5); }
            }
